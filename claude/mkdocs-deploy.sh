...
PLUGIN_VERSION=$(grep -m1 'Version:' "$PROJECT_ROOT/zsoogi-clipper.php" \
...
echo -e "  Plugin : ${YELLOW}Zsoogi Clipper v${PLUGIN_VERSION}${NC}"
...
echo ""
echo -e "${GREEN}=== Done — Zsoogi Clipper v${PLUGIN_VERSION} ===${NC}"
