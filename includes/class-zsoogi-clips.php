...
class Zsoogi_Clips {
	...
	public static function register_post_type() {
		...
		$labels = array(
			...
			'all_items'             => sprintf( __( 'All %s', 'zsoogi-clipper' ), $label_name ),
			...
			'filter_items_list'     => __( 'Filter wikis list', 'zsoogi-clipper' ),
		);

		$args = array(
			'label'               => __( 'Zsoogi Clips', 'zsoogi-clipper' ),
			'description'         => __( 'Zsoogi articles.', 'zsoogi-clipper' ),
			'labels'              => $labels,
